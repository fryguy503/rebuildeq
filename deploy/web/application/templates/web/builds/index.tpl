  ...
  <div class="container">
	...
	<div class="row" style="margin-top:60px;">
			...
			<div class="tree">
				<div class="tier" data-level="0" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-0.png">
						<div class="description"><h2>Locked And Loaded</h2>Reloading your gun gives you <em data-base="+5">+5</em>% Fire Rate<span class="perLevel"> per level</span> for a short time.</div>
					...
					<div class="skill push1" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-1.png">
						<div class="description"><h2>Quick Draw</h2><em data-base="+7">+7</em>% Weapon Swap Speed and <em data-base="+2">+2</em>% Critical Hit Damage<span class="perLevel"> per level</span>.</div>
						<div class="points" style="visibility: visible;">0/5</div>
					</div>
				</div>
				<div class="tier" data-level="1" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-2.png">
						<div class="description"><h2>I'm Your Huckleberry</h2><em data-base="+3">+3</em>% Damage and Reload Speed<span class="perLevel"> per level</span> with pistols.</div>
					...
					<div class="skill push1" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-3.png">
						<div class="description"><h2>All I Need is One</h2>Swapping weapons causes your next shot fired to deal <em data-base="+8">+8</em>% damage<span class="perLevel"> per level</span>.</div>
						<div class="points" style="visibility: hidden;">0/5</div>
					</div>
				</div>
				<div class="tier" data-level="2" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-4.png">
						<div class="description"><h2>Divergent Likeness</h2><em data-base="+6">+6</em>% Damage when Gunzerking with two of the same type of guns. <em data-base="+6">+6</em>% Accuracy when Gunzerking with two different types of guns.</div>
						<div class="points" style="visibility: hidden;">0/5</div>
					</div>
					<div class="skill" data-points="0" data-max="1"><img src="/images/builds/icons/gunzerker-gunlust-5.png">
					...
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-6.png">
						<div class="description"><h2>Money Shot</h2>The last bullet fired from any gun does <em data-base="+8">+8</em>% damage<span class="perLevel"> per level</span> per magazine size, up to <em data-base="+80">+80</em>% damage<span class="perLevel"> per level</span>.</div>
						<div class="points" style="visibility: hidden;">0/5</div>
					</div>
				</div>
				<div class="tier" data-level="3" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-7.png">
						<div class="description"><h2>Lay Waste</h2>Kill Skill. Killing an enemy gives <em data-base="+8">+8</em>% Fire Rate and <em data-base="+5">+5</em>% Critical Hit Damage with Guns<span class="perLevel"> per level</span> for a short time.</div>
						<div class="points" style="visibility: hidden;">0/5</div>
					</div>
					<div class="skill" data-points="0" data-max="1"><img src="/images/builds/icons/gunzerker-gunlust-8.png">
				...
				<div class="tier" data-level="4" data-invested="0" data-total="0">
					<div class="skill push1" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-gunlust-9.png">
						<div class="description"><h2>Keep It Piping Hot</h2>While Gunzerking is in the process of cooling down you gain <em data-base="+5">+5</em>% Gun Damage, <em data-base="+6">+6</em>% Melee Damage, and <em data-base="+5">+5</em>% Grenade Damage<span class="perLevel"> per level</span>.</div>
						<div class="points" style="visibility: hidden;">0/5</div>
					</div>
				</div>
				<div class="tier" data-level="5" data-invested="0" data-total="0">
					<div class="skill push1" data-points="0" data-max="1"><img src="/images/builds/icons/gunzerker-gunlust-10.png">
		...
		<div class="treewrapper blue">
			...
			<div class="tree">
				<div class="tier" data-level="0" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-0.png">
					...
					<div class="skill push1" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-1.png">
				...
				<div class="tier" data-level="1" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-2.png">
					...
					<div class="skill push1" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-3.png">
				...
				<div class="tier" data-level="2" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-4.png">
					...
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-6.png">
				...
				<div class="tier" data-level="3" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-7.png">
				...
				<div class="tier" data-level="4" data-invested="0" data-total="0">
					<div class="skill push1" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-rampage-9.png">
		...
		<div class="treewrapper red">
			...
			<div class="tree" unselectable="on">
				...
				<div class="tier" data-level="2" data-invested="0" data-total="0">
					...
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-brawn-6.png">
				...
				<div class="tier" data-level="3" data-invested="0" data-total="0">
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-brawn-7.png">
					...
					<div class="skill" data-points="0" data-max="5"><img src="/images/builds/icons/gunzerker-brawn-8.png">
