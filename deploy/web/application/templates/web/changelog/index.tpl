    ...
    <div class="col-md-4">
      <div class="panel">
        ...
        <span class="panel-icon {$entry->icon}"></span>
             <span class="panel-title">{$entry->date|date_format:"%Y-%m-%d"}</span>
          </div> 
          <div class="panel-body">
            <p class="">
              <div class="text-center">
                <img class="margin-top img-responsive" src="{$entry->image}" alt="{$entry->title}" data-sr="enter left, hustle 20px" width="429" height="320px">
              </div>
            </p>
          </div>
      </div>
