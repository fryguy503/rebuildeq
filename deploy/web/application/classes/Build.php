...
class Build {
	...
	public static function get_skills($class) {
		...
		switch($class) {
			...
			$newSkill->desc = 'All healing spells have a <em data-base="1">1</em>% chance <span class="perLevel">per rank</span> to cost 1 mana.';
			$newSkill->image = "/images/builds/icons/rb-clr-instilllife.png";	
			$skills[24] = $newSkill;

			$newSkill = new stdClass();
			$newSkill->title = "Celestial Breeze";
			$newSkill->desc = 'Grants the Celestial Regeneration AA with an additional <em data-base="1">1</em> mana regeneration per tick <span class="perLevel">per rank</span>.';
			$newSkill->image = "/images/builds/icons/rb-clr-instilllife.png";	
			$skills[26] = $newSkill;

			$newSkill = new stdClass();
			$newSkill->title = "Divine Arbitration";
			$newSkill->desc = 'Grants the Divine Arbitration AA, lowering the penalty by <em data-base="1">20</em>% <span class="perLevel">per rank</span>.';
			$newSkill->image = "/images/builds/icons/rb-clr-instilllife.png";	
			$skills[28] = $newSkill;

			$newSkill = new stdClass();
			$newSkill->title = "Divine Resurrection";
			$newSkill->desc = 'Grants the Divine Resurrection AA, reducing the cooldown by <em data-base="4">4</em> hours <span class="perLevel">per rank</span>.';
			$newSkill->image = "/images/builds/icons/rb-clr-instilllife.png";	
			$skills[31] = $newSkill;

			$newSkill = new stdClass();
			$newSkill->title = "Harmonic Balance";
			$newSkill->desc = 'NOT YET IMPLEMENTED.';
			$newSkill->image = "/images/builds/icons/rb-clr-instilllife.png";	
			$skills[34] = $newSkill;
