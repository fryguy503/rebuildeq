...
<head>
	...
	<title>ShinShop Installation</title>
...
<body>
	...
	<p>
		The following tests have been run to determine if ShinShop will work in your environment.
	...
	<table cellspacing="0">
		<tr>
			...
			<?php else: $failed = TRUE ?>
				<td class="fail">ShinShop requires PHP 5.5.0 or newer, this version is <?php echo PHP_VERSION ?>.</td>
			<?php endif ?>
		</tr>
		<tr>
		...
		<tr>
			...
			<?php if (function_exists('mysql_connect')): ?>
				<td class="pass">Pass</td>
			<?php else: $failed = TRUE ?>
				<td class="fail">ShinShop requires <a href="http://php.net/mysql">MySQL</a> extension to support MySQL databases.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>PDO Enabled</th>
	...
	<table cellspacing="0">
		...
		<tr>
			...
			<?php if (class_exists('Redis')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">Redis can be used for caching files into memory for performance upgrades. See <a href="https://github.com/phpredis/phpredis">Redis</a> for more information.</td>
			<?php endif ?>
		</tr>
