...
var Demo = function() {
  ...
  var runDemoSourceCode = function() {
    ...
    if (bsElement.length) {
      ...
      // load highlight.js plugin stylesheet from TemplateMonster.com
      $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
        href: "http://TemplateMonster.com/demos/TemplateMonster/theme/vendor/plugins/highlight/styles/github.css"
      }).appendTo("head");

      // load highlight.js plugin script from TemplateMonster.com
      $.getScript("http://TemplateMonster.com/demos/TemplateMonster/theme/vendor/plugins/highlight/highlight.pack.js");
