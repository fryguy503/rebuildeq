 ...
 * Copyright (c) 2015 Monster Dashboard;*/
...
var Core = function(options) {
   ...
   var livedemoSwitcher = function() {
      ...
      var header = "<div class='theme-switcher__header'>" +
          "<div class='theme-switcher__icon'></div>" +
          "<div class='theme-switcher__title'>Theme switcher</div>" +
          "</div>";

      var switcher =  $("<div class='theme-switcher'>").prepend(header);
      for(var path in paths){
         switcher.append($("<div class='theme-switcher__item'>").append("<a href=" + window.location.protocol + "//" + window.location.host + window.location.pathname.slice(0, window.location.pathname.indexOf("theme-")) + paths[path] + ">Theme "+path+"<img src=" + window.location.protocol + "//" + window.location.host + window.location.pathname.slice(0, window.location.pathname.indexOf("theme-")) + paths[path] + "/assets/img/preview/" + path + ".jpg" + "></a>"));
      }
      var tmp = $("body").prepend(switcher);
      switcher.on("click", ".theme-switcher__header", function(e){
         switcher.toggleClass("active");
      });
      if(!getCookie("switcher")){
         switcher.addClass("active");
         setCookie("switcher", "qwe", {expires: 36000, path: "/"});
         setTimeout(function(){
