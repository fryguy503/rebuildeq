...
my $encounterMessage = "Freeport guards begin to engage.";
my $encounterSound = "";
my $encounterType = "an army of freeport guards";
my $spelleffect = 0;
my $commonNpcID = 9014;
my $rareNpcID = 22067;
my $rareName = "Sergeant Slate";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "a_freeport_guard";
my $npcName2 = "a_freeport_knight";
my $npcName3 = "a_corrupted_freeport_guard";
