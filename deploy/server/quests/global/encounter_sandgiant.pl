...
my $encounterMessage = "Sand giants begin to engage.";
my $encounterSound = "";
my $encounterType = "an army of sand giants";
my $spelleffect = 0;
my $commonNpcID = 37121;
my $rareNpcID = 37175;
my $rareName = "Cazel";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "a_sand_giant";
my $npcName2 = "a_sand_giant";
my $npcName3 = "a_sand_giant";
