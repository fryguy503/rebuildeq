...
my $encounterMessage = "A Hill Giant begins engaging you.";
my $encounterSound = "";
my $encounterType = "a hill giant raid";
my $spelleffect = 0;
my $commonNpcID = 12127;
my $rareNpcID = 13008;
my $rareName = "An upset hill giant";
my $isRare = 0;
my $rarity = 30; #chance of rare spawn
my $npcName1 = "a_hill_giant";
my $npcName2 = "an_angry_hill_giant";
my $npcName3 = "a_large_creature";
