...
my $encounterMessage = "A willowisp dislikes you.";
my $encounterSound = "";
my $encounterType = "a willowisp encounter";
my $spelleffect = 0;
my $commonNpcID = 4041;
my $rareNpcID = 4035;
my $rareName = "A glowing willowisp";
my $isRare = 0;
my $rarity = 30; #chance of rare spawn
my $npcName1 = "a_willowisp";
my $npcName2 = "a_greater_wisp";
my $npcName3 = "a_wispglow";
