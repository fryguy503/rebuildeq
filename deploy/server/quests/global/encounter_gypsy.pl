...
my $encounterMessage = "Gypsies begin to dance nearby";
my $encounterSound = "";
my $encounterType = "a gypsy party";
my $spelleffect = 0;
my $commonNpcID = 37065;
my $rareNpcID = 37057;
my $rareName = "Transan the Gypsy";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "an alluring gypsy";
my $npcName2 = "a deviant gypsy";
my $npcName3 = "a gypsy";
