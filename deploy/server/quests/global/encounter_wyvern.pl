...
my $encounterMessage = "A wyvern swoops it's wings to attack.";
my $encounterSound = "";
my $encounterType = "a wyvern";
my $spelleffect = 0;
my $commonNpcID = 117003;
my $rareNpcID = 117003;
my $rareName = "";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "a_wyvern";
my $npcName2 = "a_wyvern";
my $npcName3 = "a_wyvern";
