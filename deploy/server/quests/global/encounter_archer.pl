...
my $encounterMessage = "An archer appears nearby.";
my $encounterSound = "";
my $encounterType = "an archer ambush";
my $spelleffect = 0;
my $commonNpcID = 153047;
my $rareNpcID = 153047;
my $rareName = "an archer";
my $isRare = 0;
my $rarity = 30; #chance of rare spawn
my $npcName1 = "an_archer";
my $npcName2 = "a_skilled_bowman";
my $npcName3 = "a_ranged_attacker";
