...
my $encounterMessage = "Creatures of Mistmoore begin to attack.";
my $encounterSound = "";
my $encounterType = "a mistmoore menagerie";
my $spelleffect = 0;
my $commonNpcID = 59123;
my $rareNpcID = 59150;
my $rareName = "Mynthi_Davissi";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "a_ghoulish_ancille";
my $npcName2 = "a_ghoulish_being";
my $npcName3 = "a_ghoulish_lurker";
