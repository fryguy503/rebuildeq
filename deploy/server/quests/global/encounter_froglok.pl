...
my $encounterMessage = "Frogloks begin to appear.";
my $encounterSound = "";
my $encounterType = "a froglok ambush";
my $spelleffect = 0;
my $commonNpcID = 66153;
my $rareNpcID = 22038;
my $rareName = "A Froglok Crusader";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "a froglok";
my $npcName2 = "a froglok";
my $npcName3 = "a froglok";
