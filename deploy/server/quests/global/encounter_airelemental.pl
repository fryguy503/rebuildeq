...
my $encounterMessage = "An air elemental forms before you.";
my $encounterSound = "";
my $encounterType = "an air elemental encounter";
my $spelleffect = 0;
my $commonNpcID = 22038;
my $rareNpcID = 22038;
my $rareName = "A greater air elemental";
my $isRare = 0;
my $rarity = 30; #chance of rare spawn
my $npcName1 = "an_air_elemental";
my $npcName2 = "an_air_elemental";
my $npcName3 = "an_air_elemental";
