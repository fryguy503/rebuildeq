...
my $encounterMessage = "A troll guard engages you.";
my $encounterSound = "";
my $encounterType = "a troll guard search party";
my $spelleffect = 0;
my $commonNpcID = 52002;
my $rareNpcID = 52013;
my $rareName = "Basher Rakguk";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "Basher_Sutok";
my $npcName2 = "Basher_Rakguk";
my $npcName3 = "Basher_Avisk";
