...
my $encounterMessage = "A cold wave overwhelms you.";
my $encounterSound = "";
my $encounterType = "a wave of spectres";
my $spelleffect = 0;
...
my $npcName1 = "an_odd_spectre";
my $npcName2 = "an_angry_spectre";
my $npcName3 = "a_spectre";
