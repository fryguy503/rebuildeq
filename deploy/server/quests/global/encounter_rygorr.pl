...
my $encounterMessage = "A Ry`Gorr dispatch team has found you!";
my $encounterSound = "";
my $encounterType = "a Ry`Gorr dispatch team";
my $spelleffect = 0;
my $commonNpcID = 116011;
my $rareNpcID = 116006;
my $rareName = "";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "Ry`Gorr Elite Guard";
my $npcName2 = "Ry`Gorr Elite Guard";
my $npcName3 = "Ry`Gorr Elite Guard";
