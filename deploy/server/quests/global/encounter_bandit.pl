...
my $encounterMessage = "Bandits begin to appear nearby.";
my $encounterSound = "";
my $encounterType = "a bandit takeover";
my $spelleffect = 0;
...
my $npcName1 = "a bandit";
my $npcName2 = "a hungry bandit";
my $npcName3 = "a sleepy bandit";
