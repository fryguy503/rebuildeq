...
my $encounterMessage = "Sporali begin to emerge.";
my $encounterSound = "";
my $encounterType = "a sporali infestation";
my $spelleffect = 0;
my $commonNpcID = 11016;
my $rareNpcID = 11124;
my $rareName = "A Sporali Moldmaster";
my $isRare = 0;
my $rarity = 30; #chance of rare spawn
my $npcName1 = "a_sporali";
my $npcName2 = "a_sporali";
my $npcName3 = "a_sporali";
