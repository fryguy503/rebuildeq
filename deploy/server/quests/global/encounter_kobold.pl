...
my $encounterMessage = "A large howl is heard";
my $encounterSound = "";
my $encounterType = "a kobold pack";
my $spelleffect = 0;
my $commonNpcID = 10101;
my $rareNpcID = 101016;
my $rareName = "The Growler";
my $isRare = 0;
my $rarity = 10; #chance of rare spawn
my $npcName1 = "a kobold";
my $npcName2 = "a growler";
my $npcName3 = "a biter";
