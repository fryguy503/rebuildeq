...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 20483,item2 = 20484})) then
		...
		eq.world_emote(269, "" ..e.other:GetName() .." received the epic weapon, " .. eq.item_link(20488) .. "!");
		e.other:Ding();
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 20699,item2 = 20697,item3 = 20698,item4 = 20440})) then
		...
		eq.world_emote(269, "" ..e.other:GetName() .." received the epic weapon, " .. eq.item_link(20490) .. "!");
		e.other:Ding();
		e.other:AddEXP(2500000);
