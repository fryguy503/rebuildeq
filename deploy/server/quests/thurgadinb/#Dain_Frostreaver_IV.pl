...
#Handin for the 9th ring. Needs correct dialogue
  if($faction <= 5 && plugin::check_handin(\%itemcount, 1500 => 1, 30164 => 1)) {
  ...
  #Tormax's head
    ...
    quest::ze("Let it be know from this day forth that $name and their companions are Heros of the Coldain Kingdom. King Tormax has been slain, it is a time for celebration. Let no tankard go unfilled!");
