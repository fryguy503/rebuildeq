...
var demoHighCharts = function () {
        ...
        var highColors = [bgSystem, bgPrimary, bgDanger, bgWarning,
            bgSuccess, bgSuccess, bgInfo, bgDark
        ];
                ...
                infoCircle.each(function(i, e) {
                    ...
                    var circle = Circles.create({
                        ...
                        text: function(value) {
                            ...
                            if (title) {
                                return '<h2 class="circle-text-value">' + "+" + value + "%" + '</h2><p' +
                                    ' class="circle-time">' + title + '</p>'
                            } 
                            else {
