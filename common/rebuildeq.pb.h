...
namespace google {
namespace protobuf {
template<> ::eqproto::Build* Arena::CreateMaybeMessage<::eqproto::Build>(Arena*);
template<> ::eqproto::Builds* Arena::CreateMaybeMessage<::eqproto::Builds>(Arena*);
template<> ::eqproto::Page* Arena::CreateMaybeMessage<::eqproto::Page>(Arena*);
template<> ::eqproto::Pages* Arena::CreateMaybeMessage<::eqproto::Pages>(Arena*);
template<> ::eqproto::User* Arena::CreateMaybeMessage<::eqproto::User>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace eqproto {
...
class Builds : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:eqproto.Builds) */ {
 public:
  ...
  ::eqproto::Build* mutable_builds(int index);
  ::google::protobuf::RepeatedPtrField< ::eqproto::Build >*
      mutable_builds();
  const ::eqproto::Build& builds(int index) const;
  ::eqproto::Build* add_builds();
  const ::google::protobuf::RepeatedPtrField< ::eqproto::Build >&
      builds() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::google::protobuf::RepeatedPtrField< ::eqproto::Build > builds_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_rebuildeq_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Pages : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:eqproto.Pages) */ {
 public:
  ...
  ::eqproto::Page* mutable_pages(int index);
  ::google::protobuf::RepeatedPtrField< ::eqproto::Page >*
      mutable_pages();
  const ::eqproto::Page& pages(int index) const;
  ::eqproto::Page* add_pages();
  const ::google::protobuf::RepeatedPtrField< ::eqproto::Page >&
      pages() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::google::protobuf::RepeatedPtrField< ::eqproto::Page > pages_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_rebuildeq_2eproto::TableStruct;
};
// ===================================================================
