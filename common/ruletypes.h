...
RULE_REAL(Character, FactionGainMultiplier, 1.0) //How much faction gains are modified
RULE_REAL(Character, FactionLossMultiplier, 1.0) //How much faction losses are modified
