...
func getBuildInfo(className string) (info *BuildInfo, err error) {
	...
	case "bard":
		...
		info = &BuildInfo{
			FullName: "Bard",
			Monogram: 8,
			Description: `Bards are enhanced with their songs being more powerful, focused on utility.<br>
	...
	case "cleric":
		info = &BuildInfo{
			FullName: "Cleric",
			Monogram: 2,
			Description: `Clerics have adapted to be more combat ready, focused on healing.<br>
	...
	case "druid":
		info = &BuildInfo{
			FullName: "Druid",
			Monogram: 6,
			Description: `Druids have been enhanced in their heal role, focused on healing.<br>
	...
	case "enchanter":
		info = &BuildInfo{
			FullName: "Enchanter",
			Monogram: 14,
			Description: `Enchanters have mastered magic, focused on utility.<br>
	...
	case "magician":
		info = &BuildInfo{
			FullName: "Magician",
			Monogram: 13,
			Description: `Magicians specialize in conjuration of items, focused on utility.<br>
	...
	case "monk":
		info = &BuildInfo{
			FullName: "Monk",
			Monogram: 7,
			Description: `Monks are disciplined fighters who help allies and pull enemies, focused on utility.<br>
	...
	case "necromancer":
		info = &BuildInfo{
			...
			Monogram: 11,
			Description: `Necromancers have mastered the black arts manipulating both the living and dead, focused on utility.<br>
			Their pets are significantly weaker than live EQ, and do not hold aggro well.`,
			Styles0: "Heretic",
			Styles1: "Lich",
			Styles2: "Warlock",
	...
	case "paladin":
		...
		info = &BuildInfo{
			Monogram: 3,
			FullName: "Paladin",
			Description: `Paladi: are a mix of warrior and cleric, focused on tank.<br,
	...
	case "ranger":
		info = &BuildInfo{
			FullName: "Ranger",
			Monogram: 4,
			Description: `Rangers are a mix of warrior and druid, focused on utility.<br>
	...
	case "rogue":
		info = &BuildInfo{
			FullName: "Rogue",
			Monogram: 9,
			Description: `Rogues are assassins who specialize in deception, focused on damage.<br>
	...
	case "shaman":
		info = &BuildInfo{
			FullName: "Shaman",
			Monogram: 10,
			Description: `Shamans weild spiritual powers to bring aid to allies, focused on healing.<br>
			Healer classes have an innate mana tap when they melee.`,
			Styles0: "Prophet",
			Styles1: "Oracle",
			Styles2: "Elder",
	...
	case "warrior":
		info = &BuildInfo{
			FullName: "Warrior",
			Monogram: 1,
			Description: `Warriors are masters of weapons, focused on tank.<br>
	...
	case "wizard":
		info = &BuildInfo{
			FullName: "Wizard",
			Monogram: 12,
			Description: `Wizards are masters of the elements, focused on damage.<br>
	...
	case "shadowknight":
		info = &BuildInfo{
			...
			Monogram: 5,
			Description: `Shadow Knights are a mix between warrior and necromancer, focused on tank.<br>
			Tanks are able to unlock the Charm of Defense, giving Defensive Discipline.`,
			Styles0: "Bloodreaver",
			Styles1: "Defiler",
			Styles2: "Revenant",
...
func getSkills(className string) (skills map[int]*Skill) {
	...
	case "bard":
		...
		skill = &Skill{
			...
			Description: "Mana effects on songs (lvl 20) are <em data-base='10'>10</em>% more effective<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			...
			Description: "Enhances Cassindra's Elegy (lvl 44) to also give <em data-base='2'>2</em> mana<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			Title:       "Kinsong",
			Description: "Grants the Lesson of the Devoted AA, Increasing the groups spell critical dot dmg, dot, and accuracy. 10 minute recast time, each rank reduces recast by 30 seconds.",
		...
		skill = &Skill{
			...
			Description: "Grants the Boastful Bellow AA, and lowers the reuse time by <em data-base='10'>10</em> seconds<span class='perLevel'> per rank</span>.",
	...
	case "cleric":
		...
		skill = &Skill{
			Title:       "Divine Avatar",
			Description: "Grants the Divine Avatar AA, allowing a cleric many statistic bonuses and a <em data-base='10'>10</em>% chance dodge and longer duration <span class='perLevel'> per rank</span>.",
	...
	case "druid":
		skill = &Skill{
			Title: "Entrap",
			Description: `Grants the Entrap AA, snaring the target. Mana cost increases across levels. <br>
		...
		skill = &Skill{
			...
			Description: "When a direct spell is casted, a 0 to <em data-base='1'>1</em> tick duration DoT will also affect the target if the spell casted was obtained within 15 levels of the enemy's level<span class='perLevel'> per rank</span>.",
	...
	case "enchanter":
		...
		skill = &Skill{
			Title:       "Energy Burn",
			Description: "When you use a spell that takes mana from an enemy, you now deal (mana taken * <em data-base='0.7'>0.4</em>) damage<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			Title:       "Tranquility",
			Description: "While in a group, you and your allies gain (group size * level * <em data-base='0.1'>0.1</em>) mana regen per tick<span class='perLevel'> per rank</span>",
	...
	case "monk":
		...
		skill = &Skill{
			Title:       "Divine Surge",
			Description: "When you land Tiger Claw, Eagle Strike, Tail Whip or other special attacks, your group recovers <em data-base='2'>2</em> mana within <em data-base='5'>5</em>m<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			Title:       "Purify Body",
			Description: "Grants the Purify Body AA, curing <em data-base='1'>1</em> detrimental effect on the monk<span class='perLevel'> per rank</span>. At rank 5, it will also cure resurrection sickness.",
	...
	case "necromancer":
		...
		skill = &Skill{
			Title:       "Life Link",
			Description: "Necromancer pets now recourse to the #focus target, or the necro themselves.<span class='perLevel'> per rank</span>.",
			Image:       "/images/builds/icons/rb-nec-venomstrike.png",
		}
		skills[31] = skill
		break
	...
	case "paladin":
		...
		skill = &Skill{
			Title:       "Purification",
			Description: "Grants the Purification AA, curing <em data-base='1'>1</em> detrimental effect on the paladin<span class='perLevel'> per rank</span>. At rank 5, it will also cure resurrection sickness.",
		...
		skill = &Skill{
			...
			Description: "When a heal is casted by a paladin, up to <em data-base='1'>1</em> nearby enemies of the target are dealt <em data-base='1'>1</em>% of the healing as damage. <span class='perLevel'> per rank</span>.",
	...
	case "rogue":
		...
		skill = &Skill{
			Title:       "Vital Organs",
			Description: "Backstab deals <em data-base='20'>20</em>% more damage<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			...
			Description: "When you successfully pickpocket, your group recovers <em data-base='1'>1</em>% of a target's max mana when within <em data-base='5'>5</em>m<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			Title:       "Confuse",
			Description: "When a rogue uses beg on an enemy, there is a very small chance to cause the enemy to be mesmerized for 6 seconds.",
	...
	case "shaman":
		...
		skill = &Skill{
			Title:       "Ancient Wrath",
			Description: "All direct damage spells now deal <em data-base='10'>10</em>% more damage as well as <em data-base='1'>1</em>% chance to critical hit<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			...
			Description: "Grants the Call of the Ancients AA, summoning a spirit that deals <em data-base='1'>1</em> %of an enemy's current health (maximum <em data-base='100'>100</em>) per attack<span class='perLevel'> per rank</span>.",
		...
		skill = &Skill{
			...
			Description: "Grants the Spiritual Wrath AA, attacking your target<span class='perLevel'> per rank</span>.",
	...
	default:
		...
		skill = &Skill{
			...
			Description: "When you use the Leech Touch AA, your group recover <em data-base='0.5'>0.5</em>% of a target's max mana when within <em data-base='5'>5</em>m<span class='perLevel'> per rank</span>.",
