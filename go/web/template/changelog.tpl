...
<div id="header">
    ...
    <nav role="navigation">
        ...
        <form role="search" class="navbar-form-custom" method="post" action="forum_details.html#">
        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav no-borders">
                <li class="dropdown">
                    <a class="dropdown-toggle" href="forum_details.html#" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu hdropdown notification animated flipInX">
                        ...
                        <li class="summary"><a href="forum_details.html#">See all notifications</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" href="forum_details.html#" data-toggle="dropdown">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle label-menu-corner" href="forum_details.html#" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu hdropdown animated flipInX">
                        ...
                        <li class="summary"><a href="forum_details.html#">See All Messages</a></li>
                    </ul>
                </li>
                <li>
                    <a href="forum_details.html#" id="sidebar" class="right-sidebar-toggle">
...
<aside id="menu">
    <div id="navigation">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="forum_details.html#"><span class="nav-label">Interface</span><span class="fa arrow"></span> </a>
            ...
            <li class="active">
                <a href="forum_details.html#"><span class="nav-label">App views</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
                    <li><a href="contacts.html">Contacts</a></li>
                    ...
                    <li class="active"><a href="forum_details.html">Forum details</a></li>
            ...
            <li>
                <a href="forum_details.html#"><span class="nav-label">Charts</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="forum_details.html#"><span class="nav-label">Box transitions</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="forum_details.html#"><span class="nav-label">Common views</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="forum_details.html#"><span class="nav-label">Tables</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="forum_details.html#"><span class="nav-label">Forms</span><span class="fa arrow"></span> </a>
                <ul class="nav nav-second-level">
