...
<div id="header">
    ...
    <nav role="navigation">
        ...
        <form role="search" class="navbar-form-custom" method="post" action="profile.html#">
            ...
            <ul class="nav navbar-nav no-borders">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu hdropdown notification animated flipInX">
                        ...
                        <li class="summary"><a href="/profile.html#">See all notifications</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" href="/profile.html#" data-toggle="dropdown">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle label-menu-corner" href="/profile.html#" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu hdropdown animated flipInX">
                        ...
                        <li class="summary"><a href="/profile.html#">See All Messages</a></li>
                    </ul>
                </li>
                <li>
                    <a href="/profile.html#" id="sidebar" class="right-sidebar-toggle">
