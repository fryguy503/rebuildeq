...
<header id="page-top">
    <div class="container">
        <div class="heading">
            ...
            <a href="landing_page.html#" class="btn btn-success btn-sm">Learn more</a>
        </div>
        ...
        <div class="row m-t-lg">
            <div class="col-lg-3">
                <ul class="pricing-plan list-unstyled">
                    ...
                    <li>
                        <a class="btn btn-primary btn-sm" href="landing_page.html#">Signup today</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="row text-center m-t-lg">
            <div class="col-md-4 col-md-offset-3">
                ...
                <form class="form-horizontal" role="form" method="post" action="landing_page.html#">
