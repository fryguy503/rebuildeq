...
int Mob::GetTier() {
	if (IsNPC()) {
		...
		if (npc_type_id == 71057) return 0; //Noble_Dojorn
		...
		if (npc_type_id == 71075) return 0; //Keeper_of_Souls
		if (npc_type_id == 71012) return 0; //The_Spiroc_Lord
		if (npc_type_id == 39138) return 0; //Master_Yael
		if (npc_type_id == 32040) return 0; //Lord_Nagafen
		if (npc_type_id == 73057) return 0; //Lady_Vox
		if (npc_type_id == 72090) return 0; //a_dracoliche
		if (npc_type_id == 89154) return 0; //Trakanon
		if (npc_type_id == 89181) return 0; //#Trakanon
		...
		if (npc_type_id == 72004) return 1; //Fright
		if (npc_type_id == 86014) return 1; //Gorenaire
		if (npc_type_id == 124037) return 1; //#Dozekar_the_Cursed
		if (npc_type_id == 72002) return 1; //Terror
		if (npc_type_id == 72001) return 1; //Dread
		if (npc_type_id == 103080) return 2; //Prince_Selrach_Di`zok
		if (npc_type_id == 123115) return 2; //Zlandicar
		if (npc_type_id == 102112) return 2; //#Venril_Sathir
		if (npc_type_id == 102126) return 2; //Venril_Sathir
		if (npc_type_id == 120084) return 2; //Klandicar
		if (npc_type_id == 124104) return 2; //#Telkorenar
		if (npc_type_id == 124105) return 2; //#Gozzrem
		if (npc_type_id == 72003) return 3; //Cazic_Thule
		if (npc_type_id == 103055) return 3; //Queen_Velazul_Di`zok
		if (npc_type_id == 103056) return 3; //Overking_Bathezid
		if (npc_type_id == 120005) return 3; //Sontalak
		if (npc_type_id == 112049) return 3; //Lord_Doljonijiarnimorinar
		if (npc_type_id == 113118) return 3; //Derakor_the_Vindicator
		if (npc_type_id == 124020) return 3; //#Lendiniara_the_Keeper
		...
		if (npc_type_id == 112025) return 4; //Velketor_the_Sorcerer
		if (npc_type_id == 113457) return 4; //The_Avatar_of_War
		if (npc_type_id == 124103) return 4; //#Lord_Koi`Doken
		...
		if (npc_type_id == 113215) return 5; //King_Tormax
		if (npc_type_id == 124011) return 5; //Dagarn_the_Destroyer
		if (npc_type_id == 124071) return 5; //#Cekenar
		if (npc_type_id == 124075) return 5; //#Sevalak
		if (npc_type_id == 124008) return 5; //#Lord_Feshlak
		if (npc_type_id == 124017) return 5; //#Lord_Vyemm
		if (npc_type_id == 124077) return 5; //#Lady_Mirenilla
		...
		if (npc_type_id == 113071) return 7; //The_Statue_of_Rallos_Zek
