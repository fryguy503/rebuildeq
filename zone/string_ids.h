...
#define RB_MAG_IMPROVEDPETRECLAIM 4
#define RB_MAG_MODUALTIONSHARD 6
#define RB_MAG_COMPANIONSDURABILITY 8
#define RB_MAG_SUSPENDINGMINION 10
#define RB_MAG_MENDCOMPANION 13
#define RB_MAG_COMPANIONOFNECCESSITY 16
