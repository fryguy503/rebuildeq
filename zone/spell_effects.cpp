					...
					if(effect_value > 0){
						...
						if(caster){
							...
							if (rank > 0 && (
								...
								spell_id == 1223 ||
								spell_id == 1224)) {
								int bonus_hate = int(effect_value * 0.4f * rank);
								caster->BuildEcho(StringFormat("Darkness %i increased hate generated by %i.", rank, bonus_hate));
								effect_value += bonus_hate;
							}
